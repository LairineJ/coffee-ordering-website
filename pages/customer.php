...
<head>
  ...
  <title>Cafe Haraya | Customer</title>
</head>
        ...
        $.ajax({
            ...
            success: function (html) {
                ...
                $('#selectAllCheckboxes').on('change', function () {
                    ...
                    $('input[name="cust_checkbox[]"]').prop('checked', isChecked);

                    // Trigger DataTables to redraw
                    dataTable.rows().invalidate().draw();
                });

                $('input[name="cust_checkbox[]"]').on('change', function () {
                    // Check if all checkboxes are checked
                    const allChecked = $('input[name="cust_checkbox[]"]:checked').length === $('input[name="cust_checkbox[]"]').length;
